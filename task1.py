...
class Population(object):
    ...
    def _choose_pair(self):
        ...
        # Обоими родителями не может быть одна и та же особь
        while x_a_number == x_b_number:
    ...
    def _selection(self, H):
        ...
        while sum(mask) < self.population_size:
            mask[i] = 1
            i += 1
        # Добавляем выбранные особи в новую популяцию
        H_new = []
...
population.evolute(n_steps=150)
